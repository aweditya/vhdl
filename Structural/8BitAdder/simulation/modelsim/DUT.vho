...
SIGNAL \datau[3]~1_combout\ : std_logic;
...
\datau[3]~1\ : maxv_lcell
-- Equation(s):
-- \datau[3]~1_combout\ = (\io~regout\ & ((\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & ((!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_udr~0_combout\))) # 
...
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[3]~1_combout\, , , , )
